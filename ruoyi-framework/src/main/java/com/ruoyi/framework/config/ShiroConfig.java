...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/portal/**", "anon");//注意前台博客请求不拦截
        filterChainDefinitionMap.put("/system/oss/**", "anon");//注意前台博客请求不拦截
        filterChainDefinitionMap.put("/page/view", "anon");
        filterChainDefinitionMap.put("/images/**", "anon");
        filterChainDefinitionMap.put("/loginPage/**", "anon");
        //filterChainDefinitionMap.put("/cms/portalTheme/updatePortalThemeConfig", "anon");
