...
function imgUpload(obj) {
	...
	$(oInput).on("change", function() {
		...
		var dd=doupload('upBox');
		$("#photoMeeting_upBox").val(JSON.stringify(dd));
	})
...
function imgDisplay(obj) {
	...
	var imgHtml =
		'<div style="width: 100%;height: 100vh;overflow: auto;background: rgba(0,0,0,0.5);text-align: center;position: fixed;top: 0;left: 0;z-index: 1000;"><img src=' +
		src +
